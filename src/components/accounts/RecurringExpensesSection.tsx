...
import type { RecurringExpense, BankAccount, CreditCard } from '../../store/useFinanceStore'
...
export default function RecurringExpensesSection({ recurringExpenses, accounts, creditCards = [], onAdd, onEdit, onDelete }: Props) {
    ...
    <div className="card overflow-hidden">
      ...
      >
        <div>
          ...
          <p className="text-xs text-left" style={{ color: '#f87171' }}>{formatCurrency(activeTotal)} / month</p>
        </div>
              ...
              {recurringExpenses.map((expense) => (
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs" style={{ color: 'var(--color-text-secondary)' }}>
                        ...
                        {expense.creditCardId && creditCards.find((c) => c.id === expense.creditCardId)
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <p className="text-sm font-bold" style={{ color: '#f87171' }}>{formatCurrency(expense.amount)}</p>
