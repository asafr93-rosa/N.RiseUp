    ...
    return (
      <div className="card p-3 flex flex-col gap-2.5 animate-fade-in">
        ...
        <div className="flex gap-1.5 pt-1">
          ...
          <button onClick={handleSave} className="flex-1 flex items-center justify-center gap-1 text-xs py-1.5 rounded-lg font-medium" style={{ background: '#4361EE20', color: '#4361EE', border: '1px solid #4361EE40' }}>
            <Check size={12} /> Save
          </button>
        </div>
      </div>
    ...
    <div className="card p-3 flex flex-col gap-3 animate-fade-in">
      <div className="flex items-start justify-between gap-1">
        ...
        <div className="flex gap-0.5 shrink-0">
          ...
          <button onClick={onDelete} className="p-1 rounded" style={{ color: '#EF4444' }}><Trash2 size={11} /></button>
        </div>
      </div>
