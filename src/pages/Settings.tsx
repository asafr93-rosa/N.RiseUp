  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-xs" style={{ color: '#2dd4bf' }}>{subtitle}</p>
      </div>
      <button
...
export default function Settings() {
  ...
  return (
    <div className="p-4 pb-6 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              style={{ background: 'var(--color-accent-light)', color: '#2dd4bf' }}
            >
      ...
      <section className="card p-4 flex flex-col gap-4">
        ...
        <label className="flex items-center justify-between cursor-pointer">
          ...
          <div
            ...
            style={{ background: lockSettings.enabled ? '#2dd4bf' : 'var(--color-border)' }}
            onClick={() => {
            ...
            <div className="flex gap-3">
              {Array.from({ length: PIN_LENGTH }).map((_, i) => (
                <div
                  ...
                  style={{
                    background: i < pinEntry.length ? '#2dd4bf' : 'transparent',
                    border: `2px solid ${i < pinEntry.length ? '#2dd4bf' : 'var(--color-border)'}`,
                  }}
                />
              ))}
            </div>
      ...
      <p className="text-center text-xs py-2" style={{ color: 'var(--color-text-secondary)' }}>v5.10</p>
    </div>
  )
}
